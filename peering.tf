resource "aws_vpc_peering_connection" "roboshop_to_default" {
  ...
  auto_accept = true #Auto accept works for the same accounts VPCS peering
...
resource "aws_route" "public_peering" {
  ...
  vpc_peering_connection_id = aws_vpc_peering_connection.roboshop_to_default[count.index].id
}
